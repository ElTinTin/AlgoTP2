...
// CONSTRUCTEUR 
    ...
    public Fenetre(String titre, int largeur, int hauteur) 
    {
        ...
        vacances = new Diapo();              // on charge la structure de donn�es Diapo
...
// la fenetre est constitu�e de trois parties Panel Nord : boutons ; Sud : boutons; Centre: zone de zoneDessin
 ...
 // Affichage � l'ecran dans Paint() 
    public void paint(Graphics g)   // dessin de la fen�tre g�n�rale
    {
        ...
        // c'est ici qu'il faut mettre les elements � afficher � l'ecran
        effacer();
...
// GESTION DES ACTIONS BOUTONS : cette methode est declench�e si Un bouton quelconque est appuy�
